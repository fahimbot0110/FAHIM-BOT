...
const API_URL = "https://rahatgemini-amk4.onrender.com/chat";
...
module.exports.run = async function ({ api, event, args }) {
    ...
    if (!autoReplyEnabled[senderID] && event.body.toLowerCase().indexOf("babu") !== 0) return;
